    ...
    <body>
                    ...
                    <div class="carousel-item active">
                        ...
                        <!-- <div class="carousel-caption">
                                <div class="p-3" style="max-width: 900px;">
                                    <p class="mb-5 fs-5">To promote the responsiveness of service delivery 
                                        to rights of youth through inclusive consultative policy processes in Kenya</p>
                                </div>
                            </div> -->
                    </div>
        ...
        <div class="container-fluid about">
            <div class="container py-5">
                ...
                border: 5px solid;
                border-color: transparent #1b522d transparent #1b522d;
              ">
                            <img src="img/about-img.jpg" class="img-fluid w-100 h-100" alt="" />
                        </div>
                    </div>
                    <div class="col-lg-7">
                        <h5 class="section-about-title pe-3">The Kenya Youth Assembly Foundation</h5>
                        <!-- <h1 class="mb-4">
                            Welcome to <span class="text-primary">KYAF</span>
                        </h1> -->
                        <p class="mb-4">
                            Kenya Youth Assembly Foundation is a public benefit organization
                            registered as a Trust in January 2020. It was established and
                            modeled from youth assemblies' experiences and lessons. It started
                            in 2009 as Kisauni Constituency Youth Parliament Community-Based
                            Organization with its operations in Kisauni. In 2013 it became
                            Mombasa Youth Assembly when its operations covered all six
                            constituencies of Mombasa County. Currently; its operations have
                            gone beyond Mombasa County due to the growing demand received from
                            Kenyan Youths from different counties.
                        </p>
                        <div class="accordion" id="accordionExample">
                            <div class="accordion-item">
                                ...
                                <div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne"
                                    ...
                                    <div class="accordion-body">
                                        <strong>KYAF SLOGAN </strong> Modelling transformative youth
                                        leaders of today
                                    </div>
                                </div>
                            </div>
                            <div class="accordion-item">
                                ...
                                <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo"
                                    data-bs-parent="#accordionExample">
                                    <div class="accordion-body">
                                        <strong>KYAF MISSION </strong> To promote the responsiveness
                                        of service delivery to rights of youth through inclusive
                                        consultative policy processes in Kenya
                                    </div>
                                </div>
                            </div>
                            <div class="accordion-item">
                                ...
                                <div id="collapseThree" class="accordion-collapse collapse"
                                    ...
                                    <div class="accordion-body">
                                        <strong>KYAF VISION </strong> A society where service
                                        delivery responds to the rights of its members.
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="container-fluid destination">
            <div class="container py-5">
                <div class="mx-auto text-center mb-5" style="max-width: 900px">
                    <h5 class="section-title px-3">KYAF - Events</h5>
                    <h1 class="mb-0">Popular Events</h1>
                </div>
                            ...
                            <div class="row g-4">
                                    ...
                                    <div class="row g-4">
                                            ...
                                            <div class="destination-img">
                                                ...
                                                <div class="destination-overlay p-4">
                                                    <a href="#"
                                                        ...
                                                        Photos</a>
                                                    <h4 class="text-white mb-2 mt-3">Details Goes Here</h4>
                                                </div>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="destination-img">
                                                ...
                                                <div class="search-icon">
                                                    <a href="img/destination-2.jpg" data-lightbox="destination-2"></a>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="destination-img">
                                                ...
                                                <div class="search-icon">
                                                    <a href="img/destination-7.jpg" data-lightbox="destination-7"></a>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="destination-img">
                                                ...
                                                <div class="search-icon">
                                                    <a href="img/destination-8.jpg" data-lightbox="destination-8"></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-4">
                                    <div class="destination-img h-100">
                                        ...
                                        <div class="search-icon">
                                            <a href="img/destination-9.jpg" data-lightbox="destination-4"></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="container py-5">
                ...
                <div class="packages-carousel owl-carousel">
                    ...
                    <div class="packages-item">
                        <div class="">
                            <img src="img/iri_new_logo.jpg" class="img-fluid w-50 rounded-top" alt="Image">
                    ...
                    <div class="packages-item">
                        <div class="">
                            <img src="img/NED_LOGO_Color-scaled.jpg" class="img-fluid w-100 rounded-top" alt="Image">
                        </div>
                    </div>
