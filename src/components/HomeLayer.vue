                            ...
                            <div class="row gy-0 gx-5">
                                ...
                                <div class="col-xl-7 animated fadeInLeft">
                                    <div class="text-sm-center text-md-end">
                                        <h4 class="text-primary text-uppercase fw-bold mb-4">Fatuma Masito Foundation</h4>
                                        <p class="mb-5 fs-5 text-capitalize">empowering youth and women
                                             through education, economic opportunities and advocacy</p>
                            ...
                            <div class="row g-5">
                                <div class="col-12 animated fadeInUp">
                                    <div class="text-center">
                                        <h4 class="text-primary text-capitalize fw-bold mb-4">Our Pursuit In Kwale's Climatic Conditions</h4>
                                        <p class="mb-5 fs-5 text-capitalize">committed to prioritizing effective conservation measures to safeguard our delicate ecosystem</p>
                ...
                <div class="row g-5 align-items-center">
                    <div class="col-xl-12 wow fadeInLeft" data-wow-delay="0.2s">
                        <div>
                            ...
                            <h1 class="display-5 mb-4 text-capitalize">Who We Are</h1>
                            <p class="mb-4 text-capitalize">kwale based non-profitable organisation aimed on</p>
                                            <div class="row g-5 align-items-center">
