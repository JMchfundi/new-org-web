...
export default {
  data() {
    return {
      transactionData: [
        {
          "ward": "HON. JOSEPH MALUKI MULOKA",
          "name": "TALENT DEVELOPMENT SPORTS & CULTURE"
        },
        {
          "ward": "HON. EZEKIEL MWANJE",
          "name": "EDUCATION, ICT & INNOVATION"
        },
        {
          "ward": "HON. MICHAEL KITHI",
          "name": "GENDER, SOCIAL AFFAIRS & PWD"
        },
        {
          "ward": "HON. ENOCK BARAKA",
          "name": "PEACE COHESION & TRANSFORMATION"
        },
        {
          "ward": "HON. MOHAMMED KOI",
          "name": "DEVOLUTION"
        },
        {
          "ward": "HON. LUCAS NYALE",
          "name": "ENVIRONMENT WATER & SANITATION"
        },
        {
          "ward": "HON. SHILLA SALIM",
          "name": "HEALTH"
        },
        {
          "ward": "HON. NISLA CHONI",
